...
class ResonatorTsvModel(BaseModel):
    ...
    stat_bonus_resonance_skill_bonus: str = ""
    stat_bonus_basic_attack_bonus: str = ""
    stat_bonus_heavy_attack_bonus: str = ""
    stat_bonus_resonance_liberation_bonus: str = ""

    inherent_skill_1: str = ""
    inherent_skill_2: str = ""

    stat_bonus_physical_dmg_res: str = ""
    stat_bonus_glacio_dmg_res: str = ""
    stat_bonus_fusion_dmg_res: str = ""
    stat_bonus_electro_dmg_res: str = ""
    stat_bonus_aero_dmg_res: str = ""
    stat_bonus_spectro_dmg_res: str = ""
    stat_bonus_havoc_dmg_res: str = ""
