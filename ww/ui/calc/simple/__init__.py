...
class QDamageSimple(QWidget):
    ...
    def set_results(
        ...
        data = {
            ...
            _(ZhTwEnum.RESULT_HP_P): results.result_hp_p,
            _(ZhTwEnum.RESULT_ATK): results.result_atk,
            _(ZhTwEnum.RESULT_ATK_ADDITION): results.result_atk_addition,
            _(ZhTwEnum.RESULT_ATK_P): results.result_atk_p,
            _(ZhTwEnum.RESULT_DEF): results.result_def,
            _(ZhTwEnum.RESULT_DEF_ADDITION): results.result_def_addition,
            _(ZhTwEnum.RESULT_DEF_P): results.result_def_p,
            _(ZhTwEnum.RESULT_CRIT_RATE): results.result_crit_rate,
            _(ZhTwEnum.RESULT_CRIT_DMG): results.result_crit_dmg,
            _(ZhTwEnum.RESULT_BONUS): results.result_bonus,
