...
CACHE_PATH = "./cache"
CALCULATED_RESONATOR_HTML_PATH = "./cache/v1/zh_tw/[計算用]角色.html"
RESONATORS_HTML_PATH = "./cache/v1/zh_tw/角色.html"
...
@app.command()
def search(id: str, col: ResonatorTsvColumnEnum = Argument(...)):
    table = ResonatorsTable()
