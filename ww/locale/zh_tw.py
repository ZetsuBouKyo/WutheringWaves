...
class ZhTwEnum(str, Enum):
    ...
    RESONATOR_ECHO_COST_1: str = "[聲骸]Cost1"
    RESONATOR_ECHO_COST_2: str = "[聲骸]Cost2"
    RESONATOR_ECHO_COST_3: str = "[聲骸]Cost3"
    RESONATOR_ECHO_COST_4: str = "[聲骸]Cost4"
    RESONATOR_ECHO_COST_5: str = "[聲骸]Cost5"
    RESONATOR_ECHO_AFFIX_1: str = "[聲骸]主詞條1"
    RESONATOR_ECHO_AFFIX_2: str = "[聲骸]主詞條2"
    RESONATOR_ECHO_AFFIX_3: str = "[聲骸]主詞條3"
    RESONATOR_ECHO_AFFIX_4: str = "[聲骸]主詞條4"
    RESONATOR_ECHO_AFFIX_5: str = "[聲骸]主詞條5"
    ...
    RESONATOR_SKILL_COORDINATED: str = "Coordinated"
    ...
    CALCULATED_RESONATOR_COORDINATED_ATTACK_DMG_BONUS: str = "角色協同傷害加成面板"
    ...
    RESONATOR_ECHO_COORDINATED_ATTACK_DMG_BONUS: str = "聲骸協同攻擊傷害加成"
    ...
    ECHO_ABYSSAL_PATRICIUS: str = "毒冠貴族"
    ECHO_VITREUM_DANCER: str = "琉璃刀伶"
    ECHO_LORELEI: str = "羅蕾萊"
    ECHO_SENTRY_CONSTRUCT: str = "異構武裝"
    ECHO_DRAGON_OF_DIRGE: str = "嘆息古龍"
    ECHO_HECATE: str = "赫卡忒"
    ...
    ECHO_NIGHTMARE_IMPERMANENCE_HERON: str = "夢魘·無常凶鷺"
    ECHO_NIGHTMARE_THUNDERING_MEPHIS: str = "夢魘·雲閃之鱗"
    ECHO_NIGHTMARE_TEMPEST_MEPHIS: str = "夢魘·朔雷之鱗"
    ECHO_NIGHTMARE_CROWNLESS: str = "夢魘·無冠者"
    ECHO_NIGHTMARE_INFERNO_RIDER: str = "夢魘·燎照之騎"
    ECHO_NIGHTMARE_MOURNING_AIX: str = "夢魘·哀聲鷙"
    ECHO_CAPITANEUS: str = "榮光節使"
    ECHO_NIGHTMARE_LAMPYLUMEN_MYRIAD: str = "夢魘·輝螢軍勢"
    ECHO_REMINISCENCE_FLEURDELYS: str = "共鳴迴響·芙露德莉斯"
    ECHO_KERASAUR: str = "角鱷"
    ECHO_NIGHTMARE_KELPIE: str = "夢魘·凱爾匹"
    ECHO_LIONESS_OF_GLORY: str = "榮耀獅像"
    ECHO_NIGHTMARE_HECATE: str = "夢魘·赫卡忒"
    ECHO_REMINISCENCE_FENRICO: str = "共鳴迴響·芬萊克"
    ECHO_CORROSAURUS: str = "蝕脊龍"
    ECHO_THE_FALSE_SOVEREIGN: str = "偽作的神王"
    ECHO_LADY_OF_THE_SEA: str = "海之女"
    ...
    DOCS_TIER_1_1_TITLE: str = "5星 1鏈 Tier List"
    DOCS_TIER_2_1_TITLE: str = "5星 2鏈 Tier List"
    DOCS_TIER_3_1_TITLE: str = "5星 3鏈 Tier List"
    DOCS_TIER_4_1_TITLE: str = "5星 4鏈 Tier List"
    DOCS_TIER_5_1_TITLE: str = "5星 5鏈 Tier List"
    DOCS_TIER_6_1_TITLE: str = "5星 6鏈 Tier List"
    DOCS_TIER_6_5_TITLE: str = "5星 6鏈5諧 Tier List"
